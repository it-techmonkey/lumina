...
const sections = [
  {
    ...
    content: `When we use the term "personal information," we are referring to information that identifies or can reasonably be linked to you or another person. Personal information does not include information that is collected anonymously or that has been de-identified, so that it cannot identify or be reasonably linked to you. We may collect or process the following categories of personal information, including inferences drawn from this personal information, depending on how you interact with the Services, where you live, and as permitted or required by applicable law:`,
    list: [
  ...
  },
  {
    ...
    content: 'We may collect personal information from the following sources:',
    list: [
...
export default function PrivacyPolicyPage() {
  return (
    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      {/* Header */}
      <div className="mb-10">
        <p className="text-sm text-gray-500 mb-2">Last updated: April 22, 2026</p>
        <h1 className="text-4xl font-semibold font-playfair mb-6">Privacy Policy</h1>
        <p className="text-gray-700 leading-relaxed">
          ...
          Policy controls with respect to the collection, processing, and disclosure of your
