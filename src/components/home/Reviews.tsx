...
const reviewsData = [
  {
    name: 'Emma T.',
    location: 'Amsterdam',
    product: 'Lumina · Midnight · 100×150cm',
  ...
  },
  {
    name: 'Jakob L.',
    location: 'Copenhagen',
    product: 'Lumina · Dusk Stone · 80×120cm',
  ...
  },
  {
    name: 'Sara M.',
    location: 'Helsinki',
    product: 'Lumina · Nordic White · Custom',
  ...
  },
  {
    name: 'Tom R.',
    location: 'London',
    product: 'Lumina · Midnight · 120×180cm',
  ...
  },
  {
    name: 'Annika B.',
    location: 'Stockholm',
    product: 'Lumina · Nordic White · 60×90cm',
    text: `"I love how clean and minimal it looks. The Nordic White matches my walls perfectly. Couldn't be happier — already recommended to five friends."`,
  },
  {
    name: 'David K.',
    location: 'Berlin',
    product: 'Lumina · Dusk Stone · 140×200cm',
